---
name: "Elixir"
aliases: ["Josh Foley", "Joshua Foley", "Golden Boy", "Slick", "Elixir"]
comicvine_id: 4552
cover: "images/elixir-4552.jpg"
publisher: "Marvel"
gender: "male"
appearances: 1003
first_appearance: "Not One of Us #5"
teams: []
powers: []
has_description: true
comicvine_url: "https://comicvine.gamespot.com/elixir/4005-4552/"
...
> **First appearance** Not One of Us #5
> **Appearances** 1,003
> **Also known as** Josh Foley, Joshua Foley, Golden Boy, Slick, Elixir
...
*Death touch (Elixir) vs Death touch (Wither)*
...
*Reversal of healing mastered*

 

### After his recent confrontation with the Dark Riders, Elixir's power spiked tremendously and truly showcased his Omega-level potential. With both his healing and deterioration increasing to the point where touching is no longer required, Elixir's feats include:

**Healing**:

- Reverses the forced mutation of humans for miles around (those with latent X-gene are exempt)
- Instantly cures hundreds of M-pox (a fatal disease brought on by the Terrigen mist)
- Nearly succeeds in bringing up 16 million bodies from the dead (collapsed before it was complete and those given life could have been zombies)
- Heals from damage "almost as soon as it's made"

Deterioration:

- Raises a corpse from the dead, just to snuff it out again
- Overpowers the Death touch of Wither (a fellow insta-deteriorator)
- Wolverine says "You coulda killed me. There aint 10 people in the world I'd say that to".
- Deteriorated even those with regeneratation (Sabretooth) and invulnerability (Monet), then restores their bodies to health
...
[View on Comic Vine](https://comicvine.gamespot.com/elixir/4005-4552/)
