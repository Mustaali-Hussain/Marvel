---
name: "Guardian"
aliases: ["James MacDonald Hudson", "Weapon Alpha", "Vindicator", "Antiguard", "John Wraith", "Captain Canada", "Major Maple Leaf", "Jimmy Hudson"]
comicvine_id: 5047
cover: "images/guardian-5047.jpg"
publisher: "Marvel"
gender: "male"
appearances: 736
first_appearance: "Home are the Heroes! #109"
teams: []
powers: []
has_description: true
comicvine_url: "https://comicvine.gamespot.com/guardian/4005-5047/"
...
> **First appearance** Home are the Heroes! #109
> **Appearances** 736
> **Also known as** James MacDonald Hudson, Weapon Alpha, Vindicator, Antiguard, John Wraith
...
In more recent times, Guardian, along with the rest of Alpha Flight, left Earth with a star ship full of Plodex eggs, intent on seeing the eggs home to their planet of origin. In the meantime, a new version of Alpha Flight took up the mantle of Alpha Flight while the original Flight was in space. Among these new members was [[Puck|Zuzha Yu]], the apparent daughter of Puck whom he had never spoken of before. She took on his legacy and started calling herself Puck as well.
...
James and Heather had a difficult time returning from the dead, especially when they learned they no longer had custody of their child [[Claire Hudson]]. The custody was given to family after the two of them died. The two even had to go as far as go to court to get their child back. The defense told the judge that the child would have an extreme amount of risk being parented by people whom fought as superheroes. Their assumed deaths was an example of this.
...
When Department H fell for a long and effective propaganda campaign against mutants started by Orchis, they recalled an Alpha Flight field team from the space program. Guardian would be introduced as an anti-mutant task force along with Puck, Snowbird, and Shaman. They would work in tandem with a new Box program that would use sentinel technology on loan from Orchis. However, this team was secretly conspiring with former mutant teammates Northstar and Aurora plus Heather Hudson (posing as Nemesis) and [[Daken|Fang]] to smuggle mutant refugees to friendly Shi'ar space.
...
Guardian and the other non-mutant members of Alpha Flight were arrested and imprisoned for treason.

### From the Ashes

After the fall of Orchis, Mac was one of the arrested members of Alpha Flight returned to active duty as Alpha Flight as prison release. Shaman was the only holdout. They were under the supervision of Department H member, [[Agent Arsenault]], who would lead them as the new Vindicator. They sprung into action when alien pirates chased the Alaskan X-Men into Canadian airspace. Working together, they were able to defeat the pirates. Cyclops offered to jailbreak Alpha Flight, but Mac turned him down. He believed they shamed the system that imprisoned him with every life they save.
...
[View on Comic Vine](https://comicvine.gamespot.com/guardian/4005-5047/)
