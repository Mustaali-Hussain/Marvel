---
name: "Stilt-Man"
aliases: ["Michael Watts", "Mikey", "Stiltman", "Mr. Ross", "Tall-Man", "Stuntmaster", "Wilbur Day"]
comicvine_id: 2474
cover: "images/stilt-man-2474.jpg"
publisher: "Marvel"
gender: "male"
appearances: 284
first_appearance: "The Stiltman Cometh! #8"
teams: []
powers: []
has_description: true
comicvine_url: "https://comicvine.gamespot.com/stilt-man/4005-2474/"
...
> **First appearance** The Stiltman Cometh! #8
> **Appearances** 284
> **Also known as** Michael Watts, Mikey, Stiltman, Mr. Ross, Tall-Man
...
During Day's absence from the world of costumed crime, a unnamed criminal acquired the Stilt-Man armor. This Stilt-Man was defeated by Daredevil and [[Luke Cage]]. He was next seen being dispatched by [[Carol Danvers|Ms. Marvel]] and Spider-Man.

Stilt-Man's armor was also wore by an unknown criminal with a supposed Napoleon complex. When in jail, he met The Owl and joined his Gang of Four. Together, they tried to gain control over Kingpin's criminal empire, but ultimately failed when The [[Copperhead]] double-crossed the rest of the gang and tried to bring Hell to Earth. He hung Stilt-Man and [[Gladiator (Potter)|Gladiator]] (who was an impostor of the original, too) in the church, making them see nightmarish hallucinations. When Copperhead was sent back to Hell, both Stilt-Man and Gladiator were presumably arrested.

At some point a petty criminal by the name of Michael Watts was able to come across Stilt-Man's old costume thanks to the Tinkerer. After making a notion that he should be the new Stilt-Man he was voted in also by the owner of the bar that the Punisher blew up during Stilt-Man's wake, and two other small bit criminals.
...
Stilt Man would team up with [[Rocket Racer]] and [[Leap-Frog|Leap Frog]] to commit various crimes for the Tinkerer and come into conflict with Spider Man.

## In Other Media

### Television

*Stilt-Man in the Iron Man cartoon*

- Stilt-Man makes a cameo appearance in the* Iron Man: The Animated Series* episode "Armor Wars: Part 1," voiced by Dorian Harewood. He is seen as one of the armored criminals whose suit incorporates stolen technology from Stark International. [[Iron Man]] confronts Stilt-Man while the latter is pulling off a heist, and uses his Drill Armor to destroy one of the legs. Once Stilt-Man is knocked off balance by this, Iron Man uses one of his negator packs to destroy the armor.
- While Stilt-Man himself does not appear in the series, his trademark legs can be seen in the background of [[Gladiator (Potter)|Melvin Potter]]'s shop in the first season finale of *Daredevil*.
...
- Stilt-Man was featured in the HeroClix figure game.
- Stilt-Man was featured in Diamond Select's Minimates line as part of a two-pack with Iron Man.
- Stilt-Man was featured in Hasbro's Marvel Legends line as the subject of a Build-a-Figure wave based on the animated film *Spider-Man: Into the Spider-Verse*. The Hand Ninja figure in the wave came packaged with special leg extenders for the character, meaning that, depending on the number of Hand figures purchased, collectors could make Stilt-Man as tall as they liked.
...
[View on Comic Vine](https://comicvine.gamespot.com/stilt-man/4005-2474/)
