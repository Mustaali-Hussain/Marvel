...
aliases: ["Miguel Santos", "Relámpago Vivo", "Lightning", "Sir Fulminator"]
comicvine_id: 3315
cover: "images/living-lightning-3315.jpg"
publisher: "Marvel"
gender: "male"
appearances: 279
first_appearance: "#42"
...
comicvine_url: "https://comicvine.gamespot.com/living-lightning/4005-3315/"
...
> [!infobox]
> ![[living-lightning-3315.jpg]]
> ###### Living Lightning
> **Real name** Miguel Santos
> **First appearance** #42
> **Appearances** 279
> **Also known as** Miguel Santos, Relámpago Vivo, Lightning, Sir Fulminator
...
*Name change; Lightning*

Santos had gone solo and changed his name to just "Lightning" so to not be confused with the villain, Living Laser, any longer.

The Grandmaster had teleported Earth away from its original location to be used as a gameboard in a contest of champions between the Grandmaster's Lethal Legion and the Challenger's Black Order. Most of Earth's premiere heroes were frozen in stasis to keep them from interfering, but the Elders of the Universe were not prepared for the reservists, like Lightning, who were called to active duty.

Lightning fought on many fronts, including the Grandmaster's own game room. There, Lightning kept the engine running that kept the Earth stable after the Challenger sabotaged it. He was also key in convincing the Grandmaster to return the Earth to where it was by beating him in a poker game.

### Emergency Response Squad

*Serpents and Vampires *

After Captain America defended the streets of New York City during Blood Hunt with an impromptu Avengers team, Cap was convinced that a first responder version of the team needed to be on hand while the official Avengers were dealing with the bigger picture. Lightning was chosen as one of the first members, and they set up in the old Avengers Mansion.
...
After they defeated the Serpents, they continued responding to minor emergencies while the Captain Marvel's Avengers dealt with world ending threats. While they solved these emergencies, fellow Response Squad member Night Thrasher was investigating a mysterious red monolith in Staten Island. It eventually broke open revealing the Living Monolith evolved to a new form, calling himself the Living Testament. It required Lightning and the rest of the team to stop.
...
[View on Comic Vine](https://comicvine.gamespot.com/living-lightning/4005-3315/)
