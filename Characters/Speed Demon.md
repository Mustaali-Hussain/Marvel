---
name: "Speed Demon"
aliases: ["Whizzer", "James Sanders"]
comicvine_id: 2128
cover: "images/speed-demon-2128.jpg"
publisher: "Marvel"
gender: "male"
appearances: 299
...
comicvine_url: "https://comicvine.gamespot.com/speed-demon/4005-2128/"
...
Later, Speed Demon joined the Sinister Syndicate, led by the [[Beetle (Lincoln)|Beetle]] (now the hero [[Abe Jenkins|MACH-V]]). During this time, he developed a rivalry with various other members of the team. The team proved short-lived, and Speed Demon rejoined their later incarnation led by the wife of the villain [[Strikeback|Ringer]], which was similarly disbanded shortly after, due as much to the petty in-fighting among its members as their defeat by Spider-Man.
...
Sanders recently appeared as a member of the Sinister Six, alongside Overdrive, Shocker, Boomerang, the Living Brain, and [[Beetle (Lincoln)|Beetle]]. After landing "thousands of blows in a fraction of a second", he caused Spider-Man to run away.
...
When a new team of six, including [[Morlun|Morlun,]] joins the fight, Boomer sacrifices himself to Morlun to spare Spidey. Sanders is hit hard by his teammate's death and is inspired to turn on Kindred's plan. Eventually, [[Doctor Octopus|Doc Ock]] uses a piece of [[Eric O'Grady|Black Ant's]] helmet to knock everyone, including Sanders, out through the ear centipedes Kindred was using to control them.
...
Shocker took a job retrieving a magical artifact from an armored truck. He called some old friends, Speed Demon and Overdrive, to help them. At the same time, New York was seemingly overrun with zombiotes, mindless symbiotes bonded to cadavers that could multiply through biting. Speed Demon was bit, transforming quickly, while Shocker and Overdrive tried to make a run for it.

Demon chased them right into She-Hulk, who was dealing with her own zombiofied friend, Hellcat. With Hellcat tied up, the trio hide in The Bar With No Name, while Demon and the other zombiotes pound on the security door. Inside, the reluctant allies managed to figure out a solution for zombiotes, using loud noises to purge the infection. With Overdrive using his nanomachines on Shocker's gauntlets, they kicked open the doors and started purging the infection from the horde outside, including Speed Demon.
...
- Diamond Select's [[Doctor Octopus|Superior Spider-Man]]figure featured a display base that showed Speed Demon and Beetle unconscious on the ground after having been defeated by the anti-hero.
- Speed Demon was featured in Diamond Select Minimates line.
- Speed Demon was featured in Hasbro's Marvel Legends line as part of the [[Absorbing Man]] Build-a-Figure wave. The figure also came packaged with the head of [[Silvermane|Silvio "Silvermane" Manfredi]].
...
[View on Comic Vine](https://comicvine.gamespot.com/speed-demon/4005-2128/)
