---
name: "Abe Jenkins"
aliases: ["Abner Ronald Jenkins", "Abe Jenkins", "Abner Jenkins", "Beetle", "MACH-I", "MACH-II", "MACH-III", "MACH-IV", "MACH-V", "Matthew Davis", "Aaron Jeffries", "MACH-VII", "MACH-IX", "MACH-Doom"]
comicvine_id: 4822
cover: "images/abe-jenkins-4822.jpg"
publisher: "Marvel"
gender: "male"
appearances: 626
first_appearance: "The Birth Of The Beetle!; The Challenge of Loki!; Strange Mission #123"
teams: []
powers: []
has_description: true
comicvine_url: "https://comicvine.gamespot.com/abe-jenkins/4005-4822/"
...
Abe, once again a Thunderbolt, now using newly-made MACH-X armor, initially had mixed feelings about being an outlaw again, but believed in Bucky and their cause. Abe had some happy moments with the Thunderbolts and his old teammates, feeling right having his old teammates around and going back to doing heroic things. It eventually became even better when Abe's lover Songbird also rejoined the Thunderbolts. However, these good times where not meant to last, as Baron Zemo eventually struck against the Thunderbolts and informed the team that Hydra, the altered (Nazi) Captain America and he himself where staging a coup to take power in America. While Songbird and Match-VIII refused Zemo's offer to join his new team of evildoers, the other Thunderbolts eventually sided with Zemo, defeating both Songbird and MACH-X. While Songbird managed to survive the battle, Abe was killed in action, dying as the hero he spent so much of his life trying to be.

### One World Under Doom

Doctor Doom later recruited Abe's former teammates, Fixer, Atlas, and Moonstone as enforcers for his world regime. He took advantage of Fixer and Atlas's guilt for Abe's death, and promised to use his magic to return Abe to life. Fixer constructed a cybernetic body, and Doom supposedly imbued it with Abe's soul (though it is not known if this is true or simply a ploy to control the other Thunderbolts). Now known as MACH-Doom, Abe was programmed or brainwashed to be unwaveringly loyal to Doom and served as part of the new Latverian Thunderbolts team under Valentina de Fontaine (now using the Citizen V alias).

Abe and the rest of Doom's Thunderbolts soon came into conflict with a new team of Thunderbolts, including their former teammates Bucky Barnes and Songbird, when Bucky led a strike force to a Vibranium Mine occupied by Doom in Wakanda. Abe tried to convince Songbird to join them, reminding her of their love, as did Fixer, who explained to Songbird their plan to return Abe to life. Songbird for her part, was certain that this was not really Abe, only an imitation created by Doom to manipulate her and her friends. Bucky, Songbird, and the rest of their teammates were forced to surrender when Fixer was ordered to arm a weapon of mass destruction installed in MACH-Doom by Fixer, an order Fixer reluctantly complied with.

However, Black Widow led a mission to free Bucky and Songbird from Doom, leading to a rematch between the two teams of Thunderbolts. Songbird fought MACH-Doom in one on one combat, calling him a twisted mockery of the good and wonderful man that she loved, before defeating him; Doom's Thunderbolts lost the battle and Bucky's team escaped, including Songbird and Fixer, who changed to the side of the heroes during that final battle.

It is unclear if MACH-Doom was destroyed or temporarily deactivated. It is also unclear if Doom lied to Fixer and the other Thunderbolts about using Abe's soul to create MACH-Doom, or if MACH-Doom's will was simply overriden by Doom's control.
...
[View on Comic Vine](https://comicvine.gamespot.com/abe-jenkins/4005-4822/)
