---
name: "Blob"
aliases: ["Fred Dukes", "Frederick J. Dukes", "Naomi", "Humongous"]
comicvine_id: 3182
cover: "images/blob-3182.jpg"
publisher: "Marvel"
gender: "male"
appearances: 1975
first_appearance: "Beware the Blob! #3"
teams: []
powers: []
has_description: true
comicvine_url: "https://comicvine.gamespot.com/blob/4005-3182/"
...
> **First appearance** Beware the Blob! #3
> **Appearances** 1,975
> **Also known as** Fred Dukes, Frederick J. Dukes, Naomi, Humongous
...
- Blob was featured in the X-Men: X-Force series from ToyBiz. The figure included a "rubber blubber belly" action feature to simulate the character's fat stomach, and also included a chicken leg and a ham shank as accessories.
- Blob was featured in ToyBiz's action figure line for* X-Men: Evolution*.
- Blob was featured in a two-pack with Sabretooth as part of Hasbro's line for* X-Men Origins: Wolverine*. The figure came with spring-loaded arms that would allow Blob to hurl Sabretooth through the air. Despite being released as a tie-in for the movie, the Blob's design was based on his comic incarnation rather than his live-action film counterpart.
- Blob was included in a Minimates two-pack with Wolverine from Diamond Select.
- Bowen Designs produced a Blob bust.
- Blob was featured in The Classic Marvel Figurine Collection from Eaglemoss Publications.
- Blob was featured in Hasbro's Super Hero Squad line as part of a box set that also included Wolverine, Iceman and Colossus.
- Blob was the subject of a Build-a-Figure wave for Hasbro's Marvel Legends line.
- Blob has been featured in the HeroClix figure game several times.
...
[View on Comic Vine](https://comicvine.gamespot.com/blob/4005-3182/)
